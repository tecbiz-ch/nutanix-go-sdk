...
func (c *ImageClient) Delete(ctx context.Context, s *schema.ImageIntent) error {
	return c.client.requestHelper(ctx, fmt.Sprintf(imageSinglePath, s.Metadata.UUID), http.MethodDelete, nil, nil)
}
